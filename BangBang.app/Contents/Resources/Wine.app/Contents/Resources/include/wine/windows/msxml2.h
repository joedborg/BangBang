/*** Autogenerated by WIDL 1.4.1 from msxml2.idl - Do not edit ***/
...
HRESULT STDMETHODCALLTYPE IXMLDOMDocument3_validateNode_Proxy(
    IXMLDOMDocument3* This,
    IXMLDOMNode *node,
    IXMLDOMParseError **error);
...
HRESULT STDMETHODCALLTYPE IDSOControl_get_XMLDocument_Proxy(
    IDSOControl* This,
    IXMLDOMDocument **ppDoc);
...
HRESULT STDMETHODCALLTYPE IServerXMLHTTPRequest_setTimeouts_Proxy(
    IServerXMLHTTPRequest* This,
    LONG resolveTimeout,
    LONG connectTimeout,
    LONG sendTimeout,
...
HRESULT STDMETHODCALLTYPE IServerXMLHTTPRequest2_setProxy_Proxy(
    IServerXMLHTTPRequest2* This,
    SXH_PROXY_SETTING proxySetting,
    VARIANT varProxyServer,
    VARIANT varBypassList);
...
HRESULT STDMETHODCALLTYPE IXMLDOMParseError2_get_errorXPath_Proxy(
    IXMLDOMParseError2* This,
    BSTR *xpathexpr);
...
HRESULT STDMETHODCALLTYPE IXMLDOMParseErrorCollection_get_item_Proxy(
    IXMLDOMParseErrorCollection* This,
    LONG index,
    IXMLDOMParseError2 **error);
...
HRESULT STDMETHODCALLTYPE IMXSchemaDeclHandler_schemaElementDecl_Proxy(
    IMXSchemaDeclHandler* This,
    ISchemaElement *oSchemaElement);
...
HRESULT STDMETHODCALLTYPE IMXNamespacePrefixes_get_item_Proxy(
    IMXNamespacePrefixes* This,
    LONG index,
    BSTR *prefix);
...
HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_put_allowOverride_Proxy(
    IVBMXNamespaceManager* This,
    VARIANT_BOOL fOverride);
...
HRESULT STDMETHODCALLTYPE IMXXMLFilter_getFeature_Proxy(
    IMXXMLFilter* This,
    BSTR strName,
    VARIANT_BOOL *fValue);
