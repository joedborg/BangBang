...
winebottlerApp () {
    ...
    iconv -f UTF-16LE -t UTF-8 "$BUNDLERESOURCEPATH/X11_English_Localizable.strings" > "$BOTTLE/Contents/Resources/English.lproj/Localizable.utf8"
    ...
    iconv -f UTF-8 -t UTF-16LE "$BOTTLE/Contents/Resources/English.lproj/Localizable.utf8_2" > "$BOTTLE/Contents/Resources/English.lproj/Localizable.strings"
	rm "$BOTTLE/Contents/Resources/English.lproj/Localizable.utf"*
    wait

    ditto "$BUNDLERESOURCEPATH/keyedobjects.nib" "$BOTTLE/Contents/Resources/English.lproj/main.nib/keyedobjects.nib2"
    wait
    plutil -convert xml1 "$BOTTLE/Contents/Resources/English.lproj/main.nib/keyedobjects.nib2"
    wait
    sed "s/APP_NAME/$APP_NAME/g" "$BOTTLE/Contents/Resources/English.lproj/main.nib/keyedobjects.nib2" > "$BOTTLE/Contents/Resources/English.lproj/main.nib/keyedobjects.nib"
    wait
    plutil -convert binary1 "$BOTTLE/Contents/Resources/English.lproj/main.nib/keyedobjects.nib"
	wait
    rm "$BOTTLE/Contents/Resources/English.lproj/main.nib/keyedobjects.nib2"
    wait
...
#!/bin/bash
#generated by WineBottler, can be deleted after use
